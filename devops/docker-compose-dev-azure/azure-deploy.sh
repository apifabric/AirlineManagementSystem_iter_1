...
resourcename="airlinemanagementsystemiter1"  # lower case, only
resourcegroup="airlinemanagementsystemiter1_rg"
...
# git clone https://github.com/apilogicserver/airlinemanagementsystemiter1.git
# cd airlinemanagementsystemiter1
...
az group create --name airlinemanagementsystemiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group airlinemanagementsystemiter1_rg --sku S1 --is-linux
az container create --resource-group airlinemanagementsystemiter1_rg --name airlinemanagementsystemiter1 --image apilogicserver/airlinemanagementsystemiter1:latest --dns-name-label airlinemanagementsystemiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//airlinemanagementsystemiter1.westus.azurecontainer.io:5656'
